...
public class ClawPitch {
    ...
    private static final double PITCH_PICKUP_POSITION = 0.5;//0.5;   //0.6// Pickup position
    private static final double PITCH_HANG_POSITION = 0.0;//0.8; //0.7    // 90 degrees down
