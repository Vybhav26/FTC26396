package org.firstinspires.ftc.team26396.opmodes.auto.OpenCV;
    ...
    private void telemetryAprilTag() {
        ...
        for (AprilTagDetection detection : currentDetections) {
            if (detection.metadata != null) {
                ...
                // Add condition to check if x coordinate is between -5 and 0
                if (detection.ftcPose.x >= -5 && detection.ftcPose.x <= 0) {
                    telemetry.addLine("Vybhav is dumb");
                }
            } else {
